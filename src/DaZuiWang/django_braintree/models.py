...
class MerchantCount(models.Model):
    #user= models.ForeignKey(User, unique=True)
    subMerchant_id=models.CharField(max_length=255)
    MerchantName=models.CharField(max_length=255)
    m_firstname=models.CharField(max_length=255)
    m_last_name=models.CharField(max_length=255)
    m_email=models.EmailField(max_length=255)
    m_phone=models.CharField(max_length=255)
    m_street_address=models.CharField(max_length=255)
    m_postal_code=models.CharField(max_length=255)
    m_locality=models.CharField(max_length=255)
    m_region=models.CharField(max_length=255)
    m_date_of_birth=models.DateField(max_length=255)
    m_routing_number=models.CharField(max_length=255)
    m_account_number=models.CharField(max_length=255)
    m_tos_accepted=models.CharField(max_length=255)
    m_master_merchant_account_id=models.CharField(max_length=255)
