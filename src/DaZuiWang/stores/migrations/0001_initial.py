...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'stores_product', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ...
        db.send_create_signal(u'stores', ['Product'])

        # Adding model 'ProductQuantities'
        db.create_table(u'stores_productquantities', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('product', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['stores.Product'])),
            ('order', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['stores.Order'])),
            ('quantity', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal(u'stores', ['ProductQuantities'])
        ...
        db.create_table(u'stores_order', (
            ...
            ('store', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['stores.Store'])),
            ('name_on_card', self.gf('django.db.models.fields.CharField')(max_length=255, null=True)),
            ('credit_card_type', self.gf('django.db.models.fields.CharField')(max_length=50, null=True)),
            ('credit_card_number', self.gf('django.db.models.fields.CharField')(max_length=20, null=True)),
            ('security_number', self.gf('django.db.models.fields.CharField')(max_length=4, null=True)),
            ('expiration_month', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('expiration_year', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ...
            ('zip_code', self.gf('django.db.models.fields.CharField')(max_length=255, null=True)),
            ('phone_number', self.gf('django.db.models.fields.CharField')(max_length=10, null=True)),
            ('ordered_on', self.gf('django.db.models.fields.DateTimeField')(null=True)),
            ('shipped_on', self.gf('django.db.models.fields.DateTimeField')(null=True)),
        ))
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'stores_product')

        # Deleting model 'ProductQuantities'
        db.delete_table(u'stores_productquantities')
