...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Store.image'
        db.add_column(u'stores_store', 'image',
                      self.gf('django.db.models.fields.files.ImageField')(default='null', max_length=100),
                      keep_default=False)

        # Adding field 'Store.description'
        db.add_column(u'stores_store', 'description',
                      self.gf('django.db.models.fields.TextField')(default='null'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Store.image'
        db.delete_column(u'stores_store', 'image')

        # Deleting field 'Store.description'
        db.delete_column(u'stores_store', 'description')
