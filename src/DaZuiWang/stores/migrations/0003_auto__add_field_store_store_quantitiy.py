...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Store.store_quantitiy'
        db.add_column(u'stores_store', 'store_quantitiy',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Store.store_quantitiy'
        db.delete_column(u'stores_store', 'store_quantitiy')
