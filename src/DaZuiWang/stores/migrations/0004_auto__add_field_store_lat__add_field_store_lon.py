...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Store.lat'
        db.add_column(u'stores_store', 'lat',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=20, decimal_places=16),
                      keep_default=False)

        # Adding field 'Store.lon'
        db.add_column(u'stores_store', 'lon',
                      self.gf('django.db.models.fields.DecimalField')(default=0.0, max_digits=20, decimal_places=16),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Store.lat'
        db.delete_column(u'stores_store', 'lat')

        # Deleting field 'Store.lon'
        db.delete_column(u'stores_store', 'lon')
    ...
    models = {
        ...
        u'stores.store': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.files.ImageField', [], {'max_length': '100'}),
            'lat': ('django.db.models.fields.DecimalField', [], {'max_digits': '20', 'decimal_places': '16'}),
            'lon': ('django.db.models.fields.DecimalField', [], {'max_digits': '20', 'decimal_places': '16'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
