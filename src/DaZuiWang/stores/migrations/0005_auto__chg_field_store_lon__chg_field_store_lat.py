...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Store.lon'
        db.alter_column(u'stores_store', 'lon', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=6))

        # Changing field 'Store.lat'
        db.alter_column(u'stores_store', 'lat', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=6))

    def backwards(self, orm):

        # Changing field 'Store.lon'
        db.alter_column(u'stores_store', 'lon', self.gf('django.db.models.fields.DecimalField')(max_digits=20, decimal_places=16))

        # Changing field 'Store.lat'
        db.alter_column(u'stores_store', 'lat', self.gf('django.db.models.fields.DecimalField')(max_digits=20, decimal_places=16))
