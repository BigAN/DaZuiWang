...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Order.send_time'
        db.add_column(u'stores_order', 'send_time',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'Order.pay_way'
        db.add_column(u'stores_order', 'pay_way',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Order.send_time'
        db.delete_column(u'stores_order', 'send_time')

        # Deleting field 'Order.pay_way'
        db.delete_column(u'stores_order', 'pay_way')
