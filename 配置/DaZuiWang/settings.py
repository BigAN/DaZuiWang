# Django settings for DaZuiWang project.111111111111111
import os
DEBUG = True
...
DATABASES = {
    'default': {
        ...
        'NAME': 'mysql_dazui',                      # Or path to database file if using sqlite3.
        'USER': 'dongjian',                      # Not used with sqlite3.
        'PASSWORD': 'luna1228',                  # Not used with sqlite3.
...
#                  '..',)
ROOT="/home/dongjian/webapps/dazuiwang/DaZuiWang/"
MEDIA_ROOT = '/home/dongjian/webapps/media/'

# URL that handles the media served from MEDIA_ROOT. Make sure to use a
# trailing slash.
# Examples: "http://media.lawrence.com/media/", "http://example.com/media/"
MEDIA_URL = 'http://dongjian.webfactional.com/media/'
    
# Absolute path to the directory static files should be collected to.
# Don't put anything in this directory yourself; store your static files
# in apps' "static/" subdirectories and in STATICFILES_DIRS.
# Example: "/home/media/media.lawrence.com/static/"
STATIC_ROOT = '/home/dongjian/webapps/static/'

# URL prefix for static files.
# Example: "http://media.lawrence.com/static/"
STATIC_URL = 'http://dongjian.webfactional.com/static/'
...
SECRET_KEY = '3!cyqdw(4))de40y)$1zi(_roso30*(*kva=m^!o%&amp;!-7v2q_='
